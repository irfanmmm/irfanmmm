...
## 🛠️ Tech Stack
- **Frontend:** React.js, React Native, Redux, TailwindCSS, HTML, CSS, JavaScript  
- **Backend:** Node.js, Express.js, Sequelize  
- **Databases:** MongoDB, PostgreSQL, MySQL  
- **Tools & DevOps:** Git, Docker, CI/CD, AWS, Azure  
- **Others:** REST APIs, Authentication, Payment Gateways  
